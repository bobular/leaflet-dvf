...
L.Palettes = {
    huePalette: function (d, a, e, b, c) {
        return new L.HSLHueFunction(new L.Point(d, e), new L.Point(a, b), c)
    }, luminosityPalette: function (d, a, b, e, c) {
        return new L.HSLLuminosityFunction(new L.Point(d, b), new L.Point(a, e), c)
    }, saturationPalette: function (d, a, e, b, c) {
        return new L.HSLSaturationFunction(new L.Point(d, e), new L.Point(a, b), c)
    }, rgbBlendPalette: function (e, a, b, d, c) {
        return new L.RGBColorBlendFunction(e, a, b, d, c)
    }, hslBlendPalette: function (e, a, b, d, c) {
        return new L.HSLColorBlendFunction(e, a, b, d, c)
    }, customColorPalette: function (d, a, b, c) {
        return new L.CustomColorFunction(d, a, b, c)
    }
};
L.DynamicColorPalettes = {
    rainbow: {
        text: "Rainbow", getPalette: function (c, a, b) {
            return L.Palettes.huePalette(c, a, 0, 300, b)
        }
    }, greentored: {
        text: "Green - Red", getPalette: function (c, a, b) {
            return L.Palettes.huePalette(c, a, 120, 0, b)
        }
    }, yellowtored: {
        text: "Yellow - Red", getPalette: function (c, a, b) {
            return L.Palettes.huePalette(c, a, 60, 0, b)
        }
    }, orangetored: {
        text: "Orange - Red", getPalette: function (c, a, b) {
            return L.Palettes.huePalette(c, a, 30, 0, b)
        }
    }, redtopurple: {
        text: "Red - Purple", getPalette: function (c, a, b) {
            return L.Palettes.huePalette(c, a, 360, 270, b)
        }
    }, bluetored: {
        text: "Blue - Red", getPalette: function (c, a, b) {
            return L.Palettes.huePalette(c, a, 210, 360, b)
        }
    }, bluetored2: {
        text: "Blue - Red 2", getPalette: function (c, a, b) {
            return L.Palettes.huePalette(c, a, 180, 0, b)
        }
    }, whitetored: {
        text: "White - Red", getPalette: function (c, a, b) {
            return L.Palettes.luminosityPalette(c, a, 1, 0.5, L.Util.extend(option, {outputHue: 0}))
        }
    }, whitetoorange: {
        text: "White - Orange", getPalette: function (c, a, b) {
            return L.Palettes.luminosityPalette(c, a, 1, 0.5, L.Util.extend(option, {outputHue: 30}))
        }
    }, whitetoyellow: {
        text: "White - Yellow", getPalette: function (c, a, b) {
            return L.Palettes.luminosityPalette(c, a, 1, 0.5, L.Util.extend(option, {outputHue: 60}))
        }
    }, whitetogreen: {
        text: "White - Green", getPalette: function (c, a, b) {
            return L.Palettes.luminosityPalette(c, a, 1, 0.5, L.Util.extend(option, {outputHue: 120}))
        }
    }, whitetoltblue: {
        text: "White - Lt. Blue", getPalette: function (c, a, b) {
            return L.Palettes.luminosityPalette(c, a, 1, 0.5, L.Util.extend(option, {outputHue: 180}))
        }
    }, whitetoblue: {
        text: "White - Blue", getPalette: function (c, a, b) {
            return L.Palettes.luminosityPalette(c, a, 1, 0.5, L.Util.extend(option, {outputHue: 240}))
        }
    }, whitetopurple: {
        text: "White - Purple", getPalette: function (c, a, b) {
            return L.Palettes.luminosityPalette(c, a, 1, 0.5, L.Util.extend(option, {outputHue: 270}))
        }
    }, graytored: {
        text: "Gray - Red", getPalette: function (c, a, b) {
            return L.Palettes.saturationPalette(c, a, 0, 1, L.Util.extend(option, {outputHue: 0}))
        }
    }, graytoorange: {
        text: "Gray - Orange", getPalette: function (c, a, b) {
            return L.Palettes.saturationPalette(c, a, 0, 1, L.Util.extend(option, {outputHue: 30}))
        }
    }, graytoyellow: {
        text: "Gray - Yellow", getPalette: function (c, a, b) {
            return L.Palettes.saturationPalette(c, a, 0, 1, L.Util.extend(option, {outputHue: 60}))
        }
    }, graytogreen: {
        text: "Gray - Green", getPalette: function (c, a, b) {
            return L.Palettes.saturationPalette(c, a, 0, 1, L.Util.extend(option, {outputHue: 120}))
        }
    }, graytoltblue: {
        text: "Gray - Lt. Blue", getPalette: function (c, a, b) {
            return L.Palettes.saturationPalette(c, a, 0, 1, L.Util.extend(option, {outputHue: 180}))
        }
    }, graytoblue: {
        text: "Gray - Blue", getPalette: function (c, a, b) {
            return L.Palettes.saturationPalette(c, a, 0, 1, L.Util.extend(option, {outputHue: 240}))
        }
    }, graytopurple: {
        text: "Gray - Purple", getPalette: function (c, a, b) {
            return L.Palettes.saturationPalette(c, a, 0, 1, L.Util.extend(option, {outputHue: 270}))
        }
    }
};
L.DynamicPaletteElement = L.Class.extend({
    initialize: function (b, a) {
        this._key = b;
        this._dynamicPalette = a
    }, generate: function (m) {
        var j = L.DomUtil.create("div", "palette");
        var g = m.count;
        var d = this._dynamicPalette.getPalette(0, g - 1);
        var b = m.width;
        var h = true;
        if (m.showText) {
            h = m.showText
        }
        j.setAttribute("data-palette-key", this._key);
        if (this._dynamicPalette.text && h) {
            L.DomUtil.create("div", "palette-text", j).innerHTML = '<i class="icon-ok hidden"></i>' + this._dynamicPalette.text
        }
        var k = b / g;
        if (m.className) {
            L.DomUtil.addClass(j, m.className)
        }
        for (var e = 0; e < g; ++e) {
            var c = L.DomUtil.create("i", "palette-element");
            for (var f in d) {
                var l = d[f];
                var a = l.evaluate ? l.evaluate(e) : l;
                L.StyleConverter.setCSSProperty(c, f, a)
            }
            c.style.width = k + "px";
            j.appendChild(c)
        }
